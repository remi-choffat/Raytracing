 ...
 */
public interface ServiceDistributeur2 extends Remote {
	...
	void noeudAvertirCalcul(Noeud n) throws RemoteException;
	void noeudAvertirLibre(Noeud n) throws RemoteException;
